...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Podaj poprawne wartości dla pola.",
		...
		equalTo: "Podaj wprowadzoną wartość jeszczę raz.",
		maxlength: $.validator.format( "Podaj nie więcej niż {0} znaków." ),
		minlength: $.validator.format( "Podaj przynajmniej {0} znaków." ),
		rangelength: $.validator.format( "Podaj wartość pomiędzy {0} i {1} znaków." ),
		range: $.validator.format( "Podaj wartość pomiędzy {0} i {1}." ),
